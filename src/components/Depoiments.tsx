  ...
  return (
    <div className="bg-white">
      <header className="flex flex-col items-center">
        ...
        <h1 className="text-gray-900 font-bold mt-3 text-[3.1rem] w-[37.5rem] leading-releaxed text-center" >O que os clientes dizem sobre a Saigrene</h1>
      </header>
      ...
      <div className="flex items-center justify-center gap-2 mt-[3.125rem] mb-[6.25rem]">
