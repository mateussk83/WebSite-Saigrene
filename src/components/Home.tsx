  ...
  return (
    <section id="home" className="bg-blue-300  justify-center  grid grid-flow-col">
      ...
      <header className="">
            ...
            <h1
            className="text-gray-900 font-bold mt-3 text-[3.1rem] w-[600px] leading-releaxed text-left"
            >Assistência psicologica simplificada para todos</h1>

      <div 
      id="content"
      className="mt-4 text-gray-700 font-normal text-lg leading-releaxed w-[600px]"
      >
            <p>
            ...
            <a 
            href="#"
            className="bg-blue-700 uppercase font-bold gap-[1.1rem] text-white rounded-full text-sm px-2 py-[1rem] flex justify-center w-[250px] items-center mt-8">
             <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
           ...
           <img
              className="block left-0 w-[27rem] rigth-[300px] max-w-[100%] mr-[5.2rem]"
